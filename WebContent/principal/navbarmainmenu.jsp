                      ...
                      <div class="pcoded-inner-navbar main-menu">
                          <div class="">
                              <div class="main-menu-header">
                                  <img class="img-80 img-radius" src="<%= request.getContextPath() %>/resources/assets/images/avatar-4.jpg" alt="User-Profile-Image">
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                      ...
                                      <li class=" ">
                                          <a href="<%= request.getContextPath() %>/ServLetUsuarioControler?acao=listarUser" class="waves-effect waves-dark">
